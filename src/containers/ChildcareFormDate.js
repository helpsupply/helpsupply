...
function ChildcareFormDate() {
      ...
      return [
        {
          ...
          label: t(`service.childcare.when.labels.${day}`),
          name: day,
  ...
  const fieldData = [
    ...
    },
    {
      ...
      label: t('service.childcare.when.labels.mornings'),
      name: 'mornings',
      type: formFieldTypes.INPUT_CHECKBOX,
    ...
    },
    {
      ...
      label: t('service.childcare.when.labels.afternoons'),
      name: 'afternoons',
      type: formFieldTypes.INPUT_CHECKBOX,
    ...
    },
    {
      ...
      label: t('service.childcare.when.labels.evenings'),
      name: 'evenings',
      type: formFieldTypes.INPUT_CHECKBOX,
    ...
    },
    {
      ...
      label: t('service.childcare.when.labels.nights'),
      name: 'nights',
      type: formFieldTypes.INPUT_CHECKBOX,
      value: fields.nights,
    },
    {
      ...
      label: t('service.childcare.when.labels.varies'),
      customkey: `${t('service.childcare.when.labels.varies')}-1`,
      name: 'variesTime',
      type: formFieldTypes.INPUT_CHECKBOX,
